...
class ServerClubSMS
{
    ...
    public $prefix = 'serverclubdigital_sms_woo_';
    ...
    {
        /*
         * Add Serverclub.Digital SMS SMS to woo-commerce settings.
         */
        $triggerAPI = new ServerClubDigitalTrigger();
        add_filter('woocommerce_settings_tabs_array', array($this, 'add_settings_tab') , 50);
        add_action('woocommerce_settings_tabs_settings_tab_serverclubdigital', array($this, 'settings_tab'));
        add_action('woocommerce_update_options_settings_tab_serverclubdigital', array($this, 'update_settings'));

        /*
         * Send new order admin SMS
         */
        add_action('woocommerce_order_status_processing', array($triggerAPI, 'serverclubdigi_send_admin_sms_for_woo_new_order'), 10, 1);
    }

    public function add_settings_tab($settings_tabs)
    {
        $settings_tabs['settings_tab_serverclubdigital'] = __('Serverclub.Digital SMS', $this->prefix);
    ...
    private function getFields()
    {
        ...
        $fields[] = array(
            'title' => __('Serverclub.Digital Settings', $this->prefix),
            'type' => 'title',
            'desc' => 'Provide following details from your Serverclub.Digital account. <a href="https://sms.serverclub.digital/sms-api/info" target="_blank">Click here</a> to go to API KEY section.',
            'id' => $this->prefix . 'serverclubdigital_settings'
        );
        ...
        $fields[] = array(
            ...
            'desc_tip' => __('API key available in your ServerClub Digital SMS account.', $this->prefix),
            'type' => 'text',
            'css' => 'min-width:300px;',
        );
        $fields[] = array(
            ...
            'desc_tip' => __('Enter your ServerClub Digital SMS purchased SenderID.', $this->prefix),
            'type' => 'text',
            'css' => 'min-width:300px;',
        );
        /*
